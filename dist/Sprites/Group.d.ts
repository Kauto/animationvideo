...
export default class Group<O extends SpriteGroupOptions = SpriteGroupOptions, P extends SpriteGroupOptionsInternal = SpriteGroupOptionsInternal> extends SpriteBase<O, P> {
    ...
    _getParameterList(): import('./Sprite.js').TParameterList<O, P> & {
        x: number;
        y: number;
        rotation: (value: import('./Circle.js').SpriteCircleOptions["rotation"], givenParameter: import('./Circle.js').SpriteCircleOptions) => number;
        scaleX: (value: import('./Circle.js').SpriteCircleOptions["scaleX"], givenParameter: import('./Circle.js').SpriteCircleOptions) => number;
        scaleY: (value: import('./Circle.js').SpriteCircleOptions["scaleY"], givenParameter: import('./Circle.js').SpriteCircleOptions) => number;
        alpha: number;
