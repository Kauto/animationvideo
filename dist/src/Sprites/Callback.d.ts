...
export default class Callback extends SpriteBase<SpriteCallbackOptions, SpriteCallbackOptionsInternal> {
    ...
    _getParameterList(): {
        animation: (value: import("../helper.js").OrFunction<import("../Animations/Sequence.js").default | import("../Animations/Animation.js").IAnimation[], []> | undefined, givenParameter: SpriteCallbackOptions) => import("../Animations/Sequence.js").default | undefined;
        enabled: boolean;
        isClickable: boolean;
        tag: (value: import("../helper.js").OrFunction<string | string[] | undefined, []>, givenParameter: SpriteCallbackOptions) => string[];
    } & {
        callback: (v: SpriteCallback | undefined) => SpriteCallback;
    };
