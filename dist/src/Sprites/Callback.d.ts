...
export default class Callback extends SpriteBase<SpriteCallbackOptions, SpriteCallbackOptionsInternal> {
    ...
    _getParameterList(): {
        animation: (value: import("../helper.js").OrFunction<import("../Animations/Sequence.js").TAnimationSequence, []> | undefined, givenParameter: SpriteCallbackOptions) => import("../Animations/Sequence.js").default | undefined;
        enabled: boolean;
        isClickable: boolean;
