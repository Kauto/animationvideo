...
describe('ImageManager', function () {
  ...
  it('should load assets', function () {
    expect(ImageManager.getLoaded()).to.be.equal(3);
  });

  it('should reset assets', function () {
    ImageManager.reset();
    expect(ImageManager.getLoaded()).to.be.equal(0);
    expect(ImageManager.getCount()).to.be.equal(0);
  });
});